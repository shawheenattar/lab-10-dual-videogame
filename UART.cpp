...
void UART_Init(void){
  ...
  GPIO_PORTC_AFSEL_R |= 0x30; // alt funct on PB5-4 CHECK THAT THIS IS CORRECT BEFORE USING BOARD
  GPIO_PORTC_PCTL_R = (GPIO_PORTC_PCTL_R&0xFF00FFFF)+0x00220000; // IS THIS CORRECT???
...
bool UART_InStatus(void){
  // write this
  return UART1_FR_R & UART_FR_RXFE; // replace this line
}
